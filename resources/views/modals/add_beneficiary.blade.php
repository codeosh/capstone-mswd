{{-- resources\views\modals\add_beneficiary.blade.php --}}
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addBeneficiaryForm" autocomplete="off" class="needs-validation" novalidate>
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-9">
                ...
                <div class="modal-footer mt-3">
                    ...
                    <button type="submit" class="btn btn-primary" form="addBeneficiaryForm">Add
                        Beneficiary</button>
                </div>
            </div>
